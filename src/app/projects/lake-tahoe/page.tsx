...
const TAHOE_STORY = [
  {
    id: 1,
    title: "East Tahoe Shore Trail",
    desc: "This 5.2 miles trail is one of the most beautiful way to hike the north lake tahoe area, in a typical sunny day, the lake would show it's clarity and blueish nature to people along the trail.",
    img: "/photography/tahoe-1.jpg",
  },
  {
    id: 2,
    title: "Kings Beach",
    desc: "Kayaking on lake tahoe is a great way to meditate and think through my life.",
    img: "/photography/tahoe-2.jpg",
  },
  {
    id: 3,
    title: "Crystal Bay",
    desc: "A picnic by the lake is a great weekend activity, to get away from the weekdays.",
    img: "/photography/tahoe-3.jpg",
  },
  {
    id: 4,
    title: "Balancing Rock",
    desc: "It takes 1 hour to drive from north to south tahoe, and by the balancing rock you can reveal the best scene.",
    img: "/photography/tahoe-4.jpg",
  },
  {
    id: 5,
    title: "Taylor Creek",
    desc: "From Sep, salmon run starts in south tahoe by Taylor Creek. This also draw attention to black bears who need to accumulate fat before hibernation.",
    img: "/photography/tahoe-5.jpg",
  },
  {
    id: 6,
    title: "Salmon Run",
    desc: "When the body of Kokanee Salmon turns red, it means the end of its life cycle approaches. They need to fulfill the very last destiny, fighting upstream to where they spawn, and sacrifice themselves to the great.",
